...
const {
    ...
    TodoistRequest
} = require("../../src/api_server/sources/todoist/base");
...
describe("Todoist", function() {
    ...
    describe("request", function() {
        it("disconnects source when unauthorized", function() {
            ...
            nock(TODOIST_API_BASE_URL).post("/test").reply(403, reply);
            const req_promise = new TodoistRequest(this.stubs.req, this.stubs.source.id).api(
                "test"
            );
    ...
    describe("actions", function() {
        ...
        describe("#patch_event", function() {
            ...
            it("eventually returns an event after editing its title", function() {
                ...
                nock(TODOIST_API_BASE_URL).post("/sync", expected_body).reply(200, this.stub_reply);
                return expect(
                    todoist_actions.patch_event(
                        this.stubs.req,
                        this.stubs.source,
                        this.event_id,
                        event_patch
        ...
        describe("#delete_event", function() {
            ...
            it("returns a fulfilled promise", function() {
                ...
                nock(TODOIST_API_BASE_URL).post("/sync").reply(204);
                return expect(
                    todoist_actions.delete_event(this.stubs.req, this.stubs.source, event_id) // eslint-disable-line comma-dangle
