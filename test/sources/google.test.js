...
const { GCAL_API_BASE_URL, GPLACES_API_BASE_URL } = require('../../src/api_server/sources/google/base');
    ...
    describe('actions', function () {
        ...
        describe('#load_events', function () {
            ...
            it('eventually returns a list of events', function () {
                ...
                return expect(google_actions.load_events(
        ...
        describe('#delete_event', function () {
            ...
            it('returns a fulfilled promise', function () {
                ...
                nock(GCAL_API_BASE_URL)
                    ...
                    .reply(204);
                return expect(google_actions.delete_event(
        ...
        describe('#patch_event', function () {
            ...
            beforeEach(function () {
                ...
                this.expected_uri = `/calendars/${escape(this.google_layer_id)}/events/${escape(this.google_event_id)}`;
                this.expected_query = {
            ...
            it('eventually returns an event after editing its title', function () {
                ...
                return expect(google_actions.patch_event(
            ...
            it('throws `KinInvalidFormatError` when not respecting proper format (all-day)', function () {
                ...
                return expect(
                    _.partial(google_actions.patch_event,
        ...
        describe('#create_event', function () {
            ...
            it('eventually returns an event with only a title', function () {
                ...
                nock(GCAL_API_BASE_URL)
                    ...
                    .query(this.expected_query)
                    .reply(200, this.stub_reply);
                return expect(google_actions.create_event(
                    this.stubs.req, this.stubs.source, this.layer_id, event_patch))
                    .to.eventually.deep.equal(this.expected_reply);
            });
        ...
        describe('#load_places', function () {
            ...
            it('eventually returns a list of places', function () {
                ...
                return expect(google_actions.load_places(this.stubs.req, this.stubs.source, 'france'))
                    .to.eventually.deep.equal([
                        {
                            description: 'Paris, France',
                        },
            ...
            it('eventually returns an empty list when the search query is empty', function () {
                return expect(google_actions.load_places(this.stubs.req, this.stubs.source, ''))
                    .to.eventually.deep.equal([]);
            });
        });
    });
