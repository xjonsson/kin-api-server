...
const {
    ...
    WunderlistRequest
} = require("../../src/api_server/sources/wunderlist/base");
...
describe("Wunderlist", function() {
    ...
    describe("request", function() {
        it("disconnects source when unauthorized", function() {
            ...
            nock(WUNDERLIST_API_BASE_URL).get("/test").reply(401, stub_reply);

            const req_promise = new WunderlistRequest(this.stubs.req, this.stubs.source.id).api(
                "test"
            );
    ...
    describe("actions", function() {
        describe("#load_layers", function() {
            ...
            it("eventually returns a list of layers", function() {
                nock(WUNDERLIST_API_BASE_URL).get("/lists").reply(200, [
                    {
                        id: "abcd",
                        title: "ABCD"
                    },
        ...
        describe("#load_events", function() {
            ...
            it("eventually returns a list of events", function() {
                ...
                nock(WUNDERLIST_API_BASE_URL).get("/tasks").query(true).reply(200, [
                    {
                        id: "alpha",
                        due_date: "2016-10-10",
                        title: "Alpha",
                ...
                return expect(
                    wunderlist_actions.load_events(this.stubs.req, this.stubs.source, layer_id) // eslint-disable-line comma-dangle
            ...
            it("eventually throws a `KinLayerNotFoundError` when the list is not found", function() {
                ...
                nock(WUNDERLIST_API_BASE_URL).get("/tasks").query(true).reply(404, stub_reply);
        ...
        describe("#patch_event", function() {
            ...
            it("eventually returns an event after editing its title", function() {
                ...
                return expect(
                    wunderlist_actions.patch_event(
                        this.stubs.req,
                        this.stubs.source,
                        this.event_id,
                        event_patch
        ...
        describe("#delete_event", function() {
            ...
            it("returns a fulfilled promise", function() {
                ...
                return expect(
                    wunderlist_actions.delete_event(this.stubs.req, this.stubs.source, event_id) // eslint-disable-line comma-dangle
