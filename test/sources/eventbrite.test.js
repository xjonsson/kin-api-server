...
const {
    ...
    EventbriteRequest
} = require("../../src/api_server/sources/eventbrite/base");
...
describe("Eventbrite", function() {
    ...
    describe("request", function() {
        it("disconnects source when unauthorized", function() {
            ...
            nock(EVENTBRITE_API_BASE_URL).get("/test").reply(401, stub_reply);

            const req_promise = new EventbriteRequest(this.stubs.req, this.stubs.source.id).api(
                "test"
            );
    ...
    describe("actions", function() {
        ...
        describe("#load_events", function() {
            ...
            it("eventually returns a list of events (Events I'm attending)", function() {
                ...
                return expect(
                    eventbrite_actions.load_events(this.stubs.req, this.stubs.source, layer_id) // eslint-disable-line comma-dangle
            ...
            it("eventually returns a list of events (Events I'm organizing)", function() {
                ...
                nock(EVENTBRITE_API_BASE_URL).get("/users/me/events").reply(200, {
                    events: [
                        {
                            id: "alpha",
                            name: {
