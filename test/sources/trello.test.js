...
describe("Trello", function() {
    ...
    describe("request", function() {
        it("disconnects source when unauthorized", function() {
            nock(TRELLO_API_BASE_URL).get("/test").query(true).reply(401, "invalid token");
    ...
    describe("actions", function() {
        describe("#load_layers", function() {
            ...
            it("eventually returns a list of layers", function() {
                nock(TRELLO_API_BASE_URL).get("/members/me/boards").query(true).reply(200, [
                    {
                        id: "abcd",
                        name: "ABCD",
        ...
        describe("#load_events", function() {
            it("eventually returns a list of events (from my cards)", function() {
                ...
                nock(TRELLO_API_BASE_URL).get("/members/me/cards").query(true).reply(200, [
                    {
                        id: "alpha",
                        name: "Alpha",
                ...
                return expect(
                    trello_actions.load_events(this.stubs.req, this.stubs.source, layer_id) // eslint-disable-line comma-dangle
        ...
        describe("#delete_event", function() {
            ...
            it("returns a fulfilled promise", function() {
                ...
                const trello_card_id = "alpha";
                const event_id = `kin-1234:${trello_board_id}:${trello_card_id}`;
                nock(TRELLO_API_BASE_URL).delete(`/cards/${trello_card_id}`).query(true).reply(204);
                return expect(
                    trello_actions.delete_event(this.stubs.req, this.stubs.source, event_id) // eslint-disable-line comma-dangle
