...
const {
    ...
    FacebookRequest
} = require("../../src/api_server/sources/facebook/base");
...
describe("Facebook", function() {
    ...
    describe("request", function() {
        it("disconnects source when unauthorized", function() {
            ...
            nock(FACEBOOK_API_BASE_URL).get("/test").query(true).reply(401, stub_reply);

            const req_promise = new FacebookRequest(this.stubs.req, this.stubs.source.id).api(
                "test",
                {},
                0
            );
    ...
    describe("actions", function() {
        ...
        describe("#load_events", function() {
            ...
            it("eventually returns a list of events", function() {
                ...
                nock(FACEBOOK_API_BASE_URL).get("/me/events").query(true).reply(200, {
                    data: [
                        {
                            id: "alpha",
                            name: "alpha title",
                ...
                return expect(
                    facebook_actions.load_events(this.stubs.req, this.stubs.source, layer_id) // eslint-disable-line comma-dangle
