    ...
    describe('actions', function () {
        ...
        describe('#load_events', function () {
            ...
            it('eventually returns a list of events', function () {
                ...
                return expect(github_actions.load_events(
        ...
        describe('#delete_event', function () {
            ...
            it('returns a fulfilled promise', function () {
                ...
                nock(GITHUB_API_BASE_URL)
                    .delete(`/repos/${unnormalized_github_repo_id}/milestones/${github_milestone_id}`)
                    .reply(204);
                return expect(github_actions.delete_event(
